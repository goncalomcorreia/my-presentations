...
\begin{frame}
    ...
    \begin{tikzpicture}[remember picture,overlay]
        ...
        \uncover<8->{\node[xshift=-3cm,yshift=-2cm] at (current page.center) {\includegraphics[width=0.5\columnwidth]{figures/fakenews.png}};}
    \end{tikzpicture}
\end{frame}
...
\begin{frame}
    ...
    \cornercite{lee2020POSTECHETRISubmissionWMT2020, kodama2020GeneratingResponsesthat}
    \centering
    \fontsize{12pt}{15}\selectfont
    \begin{itemize}
