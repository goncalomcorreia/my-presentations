...
\begin{frame}
    ...
    \uncover<10>{\cornercite[north east]{sparsemax, sparsemap}}
    \fontsize{12pt}{15}\selectfont
    \vspace{-0.2cm}
    \begin{columns}
        \begin{column}{0.4\columnwidth}
    ...
    \vspace{0.2cm}
    \begin{itemize}
        \uncover<10->{\item[] We use {\color{tPeony} sparsemax}, {\color{tVividBlue} top-$k$ sparsemax} and {\color{tVividBlue} SparseMAP} to allow efficient marginalization}
    \end{itemize}
...
\begin{frame}
    ...
    \begin{columns}[T]
        ...
        \begin{column}{.33\textwidth}
            \centering
            \uncover<4->{
                \textbf{\emph{better \& efficient compactness}}\\[\baselineskip]
                \includegraphics[width=0.8\columnwidth]{figures/envelopes_sparse.png}
            }
        \end{column}
    \end{columns}
