...
\begin{frame}
    ...
    \vspace{-0.3cm}
    \begin{itemize}
        \uncover<2->{\item A Simple and Effective Approach to APE with Transfer Learning
              \begin{itemize}
                  \item {\color{tPeony} weak supervision}
                  \item {\color{myDarkYellow} data-efficiency}
                  \item Poster at ACL 2019
              \end{itemize}
              }

              \vspace{0.3cm}
              \uncover<3->{\item Adaptively Sparse Transformers
              \begin{itemize}
                  \item {\color{tPeony} adaptive sparsity}
                  \item {\color{myDarkYellow} transparency}
                  \item Oral talk at EMNLP 2019
              \end{itemize}
              }

              \vspace{0.3cm}
              \uncover<4->{\item Efficient Marginalization of Discrete Latent Variables with Sparsity
              \begin{itemize}
                  \item {\color{tPeony} learnable sparsity}
                  \item {\color{myDarkYellow} compactness}
                  \item Spotlight paper at NeurIPS 2020
              \end{itemize}
              }
    \end{itemize}
\end{frame}
...
\begin{frame}
    ...
    \only<1>{\input{learning_alpha}}\only<2>{\input{learning_alpha_selected}}

    \bigskip

    \fontsize{12pt}{15}\selectfont\uncover<2->{
    ...
    \begin{columns}[T]
        ...
        \begin{column}{.33\textwidth}
            ...
            \uncover<2->{
                ...
                \vspace{0.2cm}
                \includegraphics[width=.7\textwidth]{figures/adaptive_sparsity}}%
        \end{column}
        \begin{column}{.33\textwidth}
            \centering
            \uncover<3->{
...
\begin{frame}
    \only<-8>{\frametitle{Current solutions}}\only<9->{\frametitle{{\color{tPeony} Our solution}}}
    \framesubtitle{Using emergent communication as example}
    \uncover<14>{\cornercite[north east]{sparsemax, sparsemap}}
    \fontsize{12pt}{15}\selectfont
    \begin{columns}
        \begin{column}{0.4\columnwidth}
            \centering
            ...
            \only<4->{\vspace{-0.8cm}}
            \only<1>{\includegraphics[width=0.8\columnwidth]{figures/robots-messages-3.pdf}}
            \only<2>{\includegraphics[width=0.8\columnwidth]{figures/robots-messages-2.pdf}}
            \only<3>{\includegraphics[width=0.8\columnwidth]{figures/robots-messages-1.pdf}}
            \only<4-5>{\includegraphics[width=0.8\columnwidth]{figures/envelopes_dense.png}}
            \only<6-7>{\includegraphics[width=0.8\columnwidth]{figures/envelopes_sfe.png}}
            \only<8>{\includegraphics[width=0.9\columnwidth]{figures/envelopes_gumbel.png}}
            \only<9>{\includegraphics[width=0.8\columnwidth]{figures/envelopes_dense.png}}
            \only<10-14>{\includegraphics[width=0.8\columnwidth]{figures/envelopes_sparse.png}}
            ...
            \only<1-12>{
                \begin{center}
                    \begin{tabular}{lr@{~}lr}
                        ...
                        \uncover<5->{Dense                      & $93.37$                          & {\tiny\color{gray}$\pm 0.42$}  & $256$} \\
                        \uncover<9->{\textcolor{tPeony}{Sparse} &
                        \uncover<11->{$93.35$                   & {\tiny\color{gray}$\pm 0.50$}}   &
                        \uncover<12->{$3.13${\tiny\color{gray}$\pm 0.48$}} }                                                                 \\
                        \bottomrule
                    \end{tabular}
                \end{center}
            }
...
\begin{frame}
    ...
    \fontsize{12pt}{15}\selectfont
    \begin{itemize}
        \uncover<2->{\item Semi-supervised learning: {\color{myDarkYellow} data-efficiency} and {\color{myDarkYellow} compactness}}
              \uncover<3->{\item Learning $\pi(z|x)$ without learning $\ell(x, z)$: {\color{myDarkYellow} compactness}}
              \uncover<4->{\item Latent draft translations: {\color{myDarkYellow} transparency} and {\color{myDarkYellow} compactness}}
    \end{itemize}
\end{frame}
